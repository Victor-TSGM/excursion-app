...
import { FSDropDownList } from './FSDropDownList';
...
const meta = {
    title: 'Componentes/DropDown (FSDropDownList)',
    component: FSDropDownList,
    tags: ['autodocs'],
    argTypes: {
...
} satisfies Meta<typeof FSDropDownList>;

export default meta;

type Story = StoryObj<typeof FSDropDownList>;
